        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
                    <button @click="openModal()" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded my-3">Criar novo número</button>
                    <table class="table-fixed w-full">
                        ...
                        <tbody>
                            <tr v-for="row in data">
                                ...
                                <td class="border px-4 py-2">(#{{row.customer_id}}){{ getCustomerName(row.customer_id) }}</td>
                          ...
                          <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            <div class="">
                                    <div class="mb-4">
                                      ...
                                      <select class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="exampleFormControlInput2" v-model="form.customer_id" >
                                  ...
                                  <div class="mb-4">
                                      ...
                                      <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="exampleFormControlInput1" placeholder="Digite o número" v-model="form.number">
                                  </div>
    ...
    export default {
        ...
        methods: {
            getCustomerName(id){
                for (var prop in this.customers) {
                    if ( this.customers.hasOwnProperty(prop) ) 
                        if(this.customers[prop].id == id)
                            return this.customers[prop].name;
                }
            },
            getStatus(status){
                if(status == 'active')
            ...
            save: function (data) {
                ...
                this.$inertia.post('/numbers/post', data)
                this.reset();
                this.closeModal();
                this.editMode = false;
            },
            ...
            update: function (data) {
                data._method = 'PUT';
                this.$inertia.post('/numbers/update/' + data.id, data)
                this.reset();
                this.closeModal();
            },
            deleteRow: function (data) {
                ...
                data._method = 'DELETE';
                this.$inertia.post('/numbers/delete/' + data.id, data)
                this.reset();
                this.closeModal();
            }
        }
